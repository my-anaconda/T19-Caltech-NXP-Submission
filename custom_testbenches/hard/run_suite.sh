...
for tb in tb_hard_reset_sync tb_hard_noc_local tb_hard_noc_routing tb_hard_aes_basic tb_hard_dma_basic tb_hard_apb_periph tb_hard_irq_crypto tb_hard_perf_counter tb_hard_irq_periph tb_hard_soc_cfg_regs; do
